      ...
      <div className="border-b border-border">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground uppercase tracking-wide">
            ...
            <Link href="/?type=model" className="hover:text-foreground transition-colors font-bold">
              Models
            </Link>
            <ChevronRight className="w-4 h-4" />
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="max-w-5xl mx-auto">
                    ...
                    <div className="p-4 pt-0 space-y-4 border-t border-border">
                      ...
                      {Object.entries(dimension.data.criteria).map(([key, criterion]) => (
                        <div key={key} className="p-4 bg-muted/40 border border-border rounded-md">
                          ...
                          {criterion.score !== undefined && (
                            <ScoreBar score={criterion.score} showValue={false} className="mb-3" />
                          )}
                          ...
                          <div className="flex items-center gap-3 mt-3 text-xs">
                            ...
                            <span className="text-muted-foreground">
                              Verified: {criterion.last_verified}
                            </span>
                          </div>
                        </div>
                      ))}
          ...
          {relatedEntities.length > 0 && (
            ...
            >
              <h2 className="text-2xl font-bold tracking-tight mb-6">Similar Models</h2>
